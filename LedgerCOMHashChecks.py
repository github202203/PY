...
# MAGIC       FROM MyMI_Abst_GXLP.Stg20_LedgerCOMApportionment
# MAGIC       group by CURRENCY
# MAGIC      )A
# MAGIC FULL OUTER JOIN (
# MAGIC       SELECT CURRENCY,SUM(AMT_CURR) AMT_CURR
# MAGIC       FROM mymi_pre_gxlp25.dbo_LEDG_COM
# MAGIC       group by CURRENCY
# MAGIC       )B
# MAGIC       ON A.CURRENCY = B.CURRENCY
# MAGIC FULL OUTER JOIN (
# MAGIC       SELECT CURRENCY,SUM(AMT_CURR) AMT_CURR
# MAGIC       FROM mymi_pre_gxlp.dbo_LEDG_COM
# MAGIC       group by CURRENCY
# MAGIC       )C
